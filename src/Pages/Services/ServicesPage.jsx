...
import bgimg from "../../assets/SNS.jpeg";
import ServiceimgA from "../../assets/Air_freight.jpeg";
import ServiceimgS from "../../assets/Sea_freight.jpeg";
import ServiceimgC from "../../assets/Custom.jpg";
...
const ServicesPage = () => {
  ...
  return (
    <div className="w-full bg-white dark:bg-zinc-950 font-sans mt-16 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white leading-tight tracking-tight">
            Comprehensive{" "}
            <span className="text-yellow-400 italic">Logistics Solutions</span>
          </h1>
          <p className="text-xl text-zinc-300 leading-relaxed max-w-3xl mx-auto font-medium">
            SNS International offers dependable international logistics
            solutions designed to support both commercial and personal shipping
            needs.
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-16 bg-zinc-50 dark:bg-zinc-900/50 border-b border-zinc-100 dark:border-zinc-800">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p className="text-2xl text-indigo-950 dark:text-white font-bold max-w-4xl mx-auto leading-relaxed italic">
            "We focus on making freight forwarding, courier operations and door
            to door delivery more efficient, more accessible, and more
            customer-friendly."
          </p>
        </div>
      </section>
      ...
      <div className="space-y-32 py-32 px-6 max-w-7xl mx-auto">
        ...
        <section className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-zinc-400 leading-relaxed">
              Our Air Freight Export and Import services are designed for
              businesses and individuals who need fast, dependable international
              cargo movement worldwide.
            </p>
            <div className="space-y-4 pt-4">
              <h4 className="font-bold text-indigo-900 border-l-4 border-yellow-400 pl-4 uppercase tracking-wider text-sm">
                Services Include:
              </h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  ...
                  "Cargo booking & coordination",
                  "Documentation support",
                ].map((item, idx) => (
                  <div key={idx} className="flex items-center gap-2 group">
                    <CheckCircle
                      size={18}
                      className="text-indigo-900 group-hover:text-yellow-500 transition-colors"
                    />
        ...
        <section className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-zinc-400 leading-relaxed">
              Sea freight is ideal for clients looking for cost-effective
              options for larger shipments, commercial cargo, and international
              trade movement across major seaports.
            </p>
            <div className="space-y-4 pt-4">
              <h4 className="font-bold text-indigo-900 border-l-4 border-indigo-400 pl-4 uppercase tracking-wider text-sm">
                Services Include:
              </h4>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
          ...
          <div className="relative z-10 grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-zinc-400 leading-relaxed">
                Trusted international courier services through leading global
                networks like{" "}
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                {["DHL", "FedEx", "UPS", "TNT", "Aramex"].map((p) => (
                  <span
                    key={p}
                    className="px-6 py-2 bg-white/10 backdrop-blur-md rounded-lg text-sm font-bold border border-white/10"
                  >
                    {p}
                  </span>
                ))}
              ...
              {[
                {
                  ...
                  desc: "International express parcel delivery for business and personal.",
                },
                {
                  title: "Service Optimization",
                  desc: "We help you choose the best courier based on cost and urgency.",
                },
                {
                  title: "Full Tracking",
                  desc: "Constant updates throughout the shipping process.",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-start gap-4 p-6 bg-white/5 rounded-[2rem] border border-white/5 hover:bg-white/10 transition-colors"
                >
        ...
        <section className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-zinc-400 leading-relaxed">
              Customs procedures are critical. SNS International provides
              support to manage customs-related processes effectively and reduce
              unnecessary delays.
            </p>
            <ul className="grid gap-4">
              {[
                ...
                "Shipment paperwork guidance",
                "Compliance-related assistance",
                "Commercial shipment processing",
                "Duty/Procedural consultation",
              ].map((item, idx) => (
                <li
                  key={idx}
                  className="flex items-center gap-4 text-gray-700 dark:text-zinc-400 font-bold"
                >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
            className=" rounded-[3rem] overflow-hidden shadow-2xl h-125"
          >
            <img
              src={ServiceimgC}
              alt="Documentation"
        ...
        <section className="bg-indigo-900 rounded-[3.5rem] p-12 lg:p-24 relative overflow-hidden group text-white">
          <div className="absolute bottom-0 right-0 w-full h-full opacity-5 pointer-events-none translate-y-1/2">
            <Globe
              size={800}
              className="absolute -right-40 -bottom-40 text-yellow-400"
            />
          </div>
          <div className="relative z-10 space-y-16">
            <div className="max-w-3xl space-y-6">
              <h2 className="text-4xl md:text-6xl font-black leading-tight tracking-tight">
                ...
                <span className="text-yellow-400">Trade Internationally</span>
              </h2>
              <p className="text-xl text-zinc-300 leading-relaxed font-medium">
                We provide practical logistics support for importers, exporters,
                e-commerce businesses, and SMEs specialized in navigating global
                trade challenges.
              </p>
            </div>
              ...
              <div className="space-y-6 bg-white/5 backdrop-blur-md p-10 rounded-[2.5rem] border border-white/10">
                ...
                <ul className="grid gap-3">
                  {[
                    ...
                    <li
                      key={idx}
                      className="flex items-center gap-3 text-zinc-300 font-medium italic underline decoration-white/20 underline-offset-4"
                    >
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <div
                      key={s}
                      className="px-6 py-4 bg-white/10 rounded-2xl border border-white/5 font-bold hover:bg-yellow-400 hover:text-indigo-950 hover:-translate-y-1 transition-all"
                    >
                      {s}
                    </div>
                  ))}
                ...
                <p className="text-zinc-400 text-sm italic font-medium pt-8">
                  "Our goal is to make logistics simpler so our clients can
      ...
      {/* FINAL CTA SECTION */}
      <section className="bg-yellow-400 py-10 px-6 text-center">
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
        ...
        >
          <h2 className="text-4xl md:text-5xl font-black text-indigo-950 tracking-tight leading-tight italic">
            Ready to move your cargo?
          </h2>
          <p className="text-xl text-indigo-900 font-bold opacity-80 leading-relaxed">
            Experience the SNS International standard of reliability and
            expertise in every shipment.
          </p>
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <button
              ...
              className="px-12 py-5 bg-white text-indigo-950 rounded-full font-black text-lg shadow-md hover:bg-zinc-50 hover:scale-105 active:scale-95 transition-all"
            >
