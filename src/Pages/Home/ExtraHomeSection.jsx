        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold leading-tight text-indigo-950 dark:text-white">
              ...
              <span className="text-yellow-500 italic">Global Logistics</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-zinc-400 leading-relaxed">
              SNS International is a trusted Bangladeshi logistics company
              specializing in freight forwarding, international courier, cargo
              movement, and shipping support services.
            </p>
            <p className="text-lg text-gray-600 dark:text-zinc-400 leading-relaxed">
              With over 8 years of experience, we help businesses and
              individuals manage global shipping more efficiently through strong
              logistics coordination and partnerships with leading international
              courier networks such as DHL, FedEx, UPS, TNT, and Aramex.
            </p>
            <p className="text-lg text-indigo-900 dark:text-zinc-300 font-medium italic border-l-4 border-yellow-500 pl-4 bg-yellow-50/50 dark:bg-zinc-800/30 py-2 rounded-r-lg">
              "At SNS International, we believe shipping is not just about
              transportation — it is about creating opportunities, solving
              logistics challenges, and supporting business growth."
            </p>
            <motion.button
      ...
      <section className="bg-zinc-50 dark:bg-zinc-800/20 py-24">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <h2 className="text-4xl font-bold tracking-tight text-indigo-950 dark:text-white">
              <GradientText className="inline-block pb-1">
                {" "}
                Why Choose SNS International{" "}
              </GradientText>
            </h2>
            <p className="text-lg text-gray-600 dark:text-zinc-400">
              Delivering excellence through reliability, network, and expertise.
            </p>
          </div>
          ...
          >
            {[
              ...
              },
              {
                ...
                desc: "Reliable connections across Asia, Europe, the Middle East, the USA, and beyond.",
              },
              {
                icon: BadgePercent,
                title: "Competitive Rates",
                desc: "Cost-effective shipping solutions without compromising service quality.",
              },
              {
                icon: Users,
                title: "Business-Focused Support",
                desc: "Helping importers, exporters, e-commerce sellers, and growing businesses ship with confidence.",
              },
              {
                icon: FileText,
                title: "Documentation & Customs Assistance",
                desc: "Support with paperwork, coordination, and customs-related processes.",
              },
              {
                icon: ShieldCheck,
                title: "Customer-First Service",
                desc: "Responsive communication, shipment follow-up, and dedicated service at every stage.",
              },
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="space-y-4">
            <h2 className="text-4xl font-bold text-indigo-950 dark:text-white">
              Our Services
            </h2>
            <p className="text-lg text-gray-600 dark:text-zinc-400 max-w-xl">
              Comprehensive logistics solutions tailored to your unique
              requirements.
            </p>
          </div>
          <motion.button
          ...
          {[
            {
              icon: Plane,
              title: "Air Freight",
              desc: "Fast and reliable international air cargo services worldwide.",
            },
            {
              icon: Ship,
              title: "Sea Freight",
              desc: "Cost-effective sea cargo solutions for global commercial trade.",
            },
            {
              icon: Truck,
              title: "Global Courier",
              desc: "Express delivery through DHL, FedEx, UPS, TNT, and Aramex.",
            },
            {
              icon: FileText,
              title: "Customs Brokerage",
              desc: "Professional assistance with clearance and compliance.",
            },
            {
              icon: Users,
              title: "Import & Export",
              desc: "Practical shipping solutions for businesses and entrepreneurs.",
            },
          ].map((item, index) => (
            <motion.div
              key={index}
      ...
      <section className="container mx-auto px-6 mb-8">
        <div className="bg-linear-to-br from-yellow-50 via-white to-purple-50 dark:from-zinc-900 dark:to-zinc-950 border border-yellow-100 dark:border-zinc-800 text-zinc-900 dark:text-white rounded-[3rem] p-12 md:p-20 overflow-hidden relative shadow-2xl">
          <div className="absolute top-0 right-0 w-1/2 h-full opacity-10 dark:opacity-5 pointer-events-none">
            <Globe2
              size={500}
              className="absolute -right-20 -top-20 text-indigo-900 transition-transform duration-1000 group-hover:rotate-12"
            />
          </div>

          <div className="relative z-10 max-w-4xl">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 italic text-indigo-950 dark:text-white">
              Our Global Reach
            </h2>
            <p className="text-xl text-gray-600 dark:text-zinc-400 mb-12 leading-relaxed">
              SNS International supports shipments across key international
              markets with strong logistics connectivity and operational
              support. We help clients find the most efficient route, service,
              and shipping solution for each destination.
            </p>
