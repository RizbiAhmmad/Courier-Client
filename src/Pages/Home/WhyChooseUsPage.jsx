...
import bgimg from "../../assets/Choose_Us.jpg";
      ...
      >
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white leading-tight tracking-tight">
            Why Choose{" "}
            <span className="text-yellow-400 italic font-medium">
              SNS International?
            </span>
          </h1>
          <p className="text-xl text-zinc-300 leading-relaxed max-w-3xl mx-auto font-medium">
            Choosing the right logistics partner is vital for your success. We
            combine experience, responsiveness, and practical support to deliver
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {[
              ...
              {
                icon: Globe,
                title: "Reliable Global Connectivity",
              ...
              {
                icon: MessageSquare,
                title: "Strong Service Communication",
              ...
              >
                <div
                  className={`w-16 h-16 bg-yellow-400 text-indigo-950 rounded-2xl flex items-center justify-center shrink-0 mb-8 group-hover:rotate-12 transition-transform duration-500 ${reason.full ? "lg:mb-0" : ""}`}
                >
                  <reason.icon size={32} />
                </div>
                <div>
                  <h3 className="text-2xl font-black text-indigo-950 dark:text-white mb-4 italic leading-tight">
                    {reason.title}
                  </h3>
                  <p className="text-gray-600 dark:text-zinc-400 leading-relaxed font-medium">
                    "At SNS International, we don’t just deliver goods — we
                    deliver reliability."
                  </p>
                  <p className="mt-4 text-gray-500 dark:text-zinc-500 text-md">
                    {reason.desc}
                  </p>
                </div>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="max-w-3xl space-y-4 mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-indigo-950 dark:text-white tracking-tight leading-tight">
              Industries <br />{" "}
              <span className="text-yellow-500">We Fully Serve</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-zinc-400 font-medium leading-relaxed">
              SNS International supports a wide range of businesses and clients
              with flexible logistics and shipping solutions tailored to
          ...
          >
            {[
              {
                ...
                desc: "Helping online sellers move products internationally.",
              },
              {
                icon: Shirt,
                title: "Fashion & Apparel",
                desc: "Supporting distribution of garments and accessories.",
              },
              {
                icon: BarChart3,
                title: "Trading Businesses",
                desc: "Logistics support for import/export operations.",
              },
              {
                icon: Factory,
                title: "Small & Medium Enterprises",
                desc: "Shipping support for growing global businesses.",
              },
              {
                icon: Layers,
                title: "Commercial Importers/Exporters",
                desc: "Freight and cargo solutions for regular business shipments.",
              },
              {
                icon: Package,
                title: "Retail Product Suppliers",
                desc: "Inventory and order delivery internationally.",
              },
              {
                icon: Home,
                title: "Personal Shipment Clients",
                desc: "Support for documents and personal cargo worldwide.",
              },
            ].map((industry, idx) => (
              <motion.div
                key={idx}
              ...
              >
                ...
                <h4 className="text-lg font-bold text-indigo-950 dark:text-white mb-3 leading-snug">
                  {industry.title}
                </h4>
                <p className="text-md text-gray-500 dark:text-zinc-400 leading-relaxed font-semibold italic">
                  {industry.desc}
                </p>
            ...
            >
              ...
              <p className="text-xs text-zinc-300 font-bold opacity-80">
                Whether small, urgent, or commercial, we are ready to support
                your needs.
              </p>
              <button className="px-6 py-3 bg-yellow-400 text-indigo-950 rounded-xl font-bold hover:scale-105 active:scale-95 transition-all w-full">
                Get Started
              </button>
            </motion.div>
          </motion.div>
      ...
      <section className="bg-yellow-400 py-16 px-6 text-center">
        ...
        >
          <h2 className="text-4xl font-black text-indigo-950 tracking-tight leading-tight">
            "At SNS International, we don’t just deliver goods —{" "}
            <span className="italic">we deliver reliability.</span>"
          </h2>
          <div className="flex flex-wrap justify-center gap-4 pt-4">
            ...
            <button className="px-10 py-4 bg-white text-indigo-950 rounded-full font-bold shadow-md hover:bg-zinc-50 transition-all hover:scale-105">
              Contact Us
            </button>
          </div>
        </motion.div>
