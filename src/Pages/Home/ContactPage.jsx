    ...
    <div className="w-full bg-white dark:bg-zinc-950 font-sans mt-16 overflow-hidden">
      ...
      <section className="relative min-h-125 flex items-center justify-center text-center px-6 py-20 bg-indigo-950">
        ...
        >
          ...
          <p className="text-xl text-zinc-300 leading-relaxed max-w-3xl mx-auto font-medium">
            Need support with international courier, freight forwarding,
            import/export logistics, air freight, sea freight, or customs
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {[
              ...
              >
                <div
                  className={`w-16 h-16 mx-auto rounded-2xl flex items-center justify-center mb-6 ${card.color} transition-all duration-500 group-hover:rotate-12`}
                >
                  <card.icon size={28} />
                </div>
                ...
                <p className="text-lg font-bold text-gray-800 dark:text-zinc-200 mb-1">
                  {card.info}
                </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              <div className="space-y-4">
                <h2 className="text-4xl font-black text-indigo-950 dark:text-white leading-tight">
                  Send Us a{" "}
                ...
                <p className="text-gray-600 dark:text-zinc-400 font-medium leading-relaxed">
                  Have a specific shipment requirement or need a custom
                  logistics plan? Fill out the form and our experts will contact
                  you shortly.
                </p>
              </div>
            ...
            <motion.div
              ...
              className="space-y-8"
            >
              <div className="rounded-[3rem] overflow-hidden shadow-2xl h-100 border-8 border-white dark:border-zinc-800">
                <iframe
              ...
              <div className="bg-indigo-950 p-8 md:p-12 rounded-[3rem] text-white space-y-8 group overflow-hidden relative">
                ...
                <h4 className="text-2xl font-bold italic text-yellow-400">
                  Support Hours
                </h4>
                <div className="space-y-4">
      ...
      <section className="bg-yellow-400 py-16 px-6 text-center shadow-lg">
        <div className="max-w-4xl mx-auto space-y-6">
          <h2 className="text-4xl font-black text-indigo-950 tracking-tight leading-tight italic">
            Global Shipping. Simplified.
          </h2>
          <p className="text-indigo-900 font-bold opacity-80 leading-relaxed max-w-2xl mx-auto">
            Experience the peace of mind that comes with a dedicated logistics
