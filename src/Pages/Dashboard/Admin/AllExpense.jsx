...
<div className="flex flex-col gap-4 mb-6 lg:flex-row lg:items-center lg:justify-between">
  ...
  <button
    ...
    className="flex items-center justify-center gap-2 px-5 py-2 text-white bg-linear-to-r from-yellow-400 to-orange-500 rounded-xl hover:from-yellow-500 hover:to-orange-600"
  >
    <FaPlus /> Add Expense
  </button>
